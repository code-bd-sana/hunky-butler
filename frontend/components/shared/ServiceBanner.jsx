...
const ServiceBanner = () => {
  return (
    <div
      className={`relative h-[80vh] w-full overflow-hidden bg-[linear-gradient(180deg,rgba(0,0,0,0)_13%,rgba(0,0,0,1)_95%),url('/serviceBanner/buff.jpeg')] bg-cover bg-center`}
    >
      {/* Main Content */}
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
        ...
        <h1 className="mb-2 max-w-7xl text-4xl tracking-[-1px] font-medium text-white md:text-5xl lg:text-[68px]">
          Hire Buff Butlers for an unforgettable party experience
        </h1>

        <p className="mb-8 mt-4 max-w-7xl tracking-[-1px] text-lg text-white md:text-xl">
          Fun, cheeky, and professional hosts to keep your guests entertained.
        </p>
