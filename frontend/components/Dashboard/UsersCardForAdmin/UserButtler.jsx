...
export default function UserButtler() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div className="bg-[#6A24A0] text-white p-6 pt-8 rounded-xl shadow-md space-y-4">
        ...
        <p className="text-3xl md:text-4xl lg:text-5xl font-bold">12,234</p>
      ...
      <div className="bg-[#6A24A0] text-white p-6  pt-8  rounded-xl shadow-md space-y-4">
        ...
        <p className="text-3xl md:text-4xl lg:text-5xl font-bold">123</p>
        <span className="text-sm md:text-base lg:text-lg  opacity-90">
          Updated 1 min ago
        </span>
      </div>
      ...
      <div className="bg-[#A06224] text-white p-6  pt-8  rounded-xl shadow-md space-y-4">
        ...
        <p className="text-3xl md:text-4xl lg:text-5xl font-bold">12</p>
        <span className="text-sm md:text-base lg:text-lg  opacity-90">
          Updated 1 min ago
        </span>
      </div>
