        ...
        <div className='max-w-7xl mx-auto md:flex px-4 md:px-0 items-center gap-4 mt-16'>
            ...
            <section className='flex-1'>
                ...
                <div>
                    ...
                    >
                    <SubTitle text={' Discover exciting services like Buff Butlers, Cocktail Masterclasses, and Life Drawing.'}/>
                    </p>
                  </div>
                      <div  className="flex gap-4 items-center">
                    <Image alt="icon" src={icon} />{" "}
                    ...
                    >
                    <SubTitle text={' Connect with verified professionals who are reviewed, rated, and ready to bring the fun.'}/>
                    </p>
                  </div>
                </div>
...
{/* icn section */}
        <section className='md:flex  justify-between max-w-7xl mx-auto mt-16'>
          ...
          <div className='border-r  border-[#FF99C3]'>
