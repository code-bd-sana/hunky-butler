...
const FaqLocation = ({ location }) => {
  ...
  const faqs = [
    {
      question: "What does a Hunky Butler do at parties?",
      answer:
        "A Hunky Butler serves drinks, hosts games, and ensures your guests are entertained while keeping the mood light and classy.",
    },
    {
      question: "Can I choose how my butlers dress?",
      answer:
    ...
    <div className="w-full max-w-[1240px] mx-auto mt-20 mb-20">
      <div className="text-center w-2/3 mx-auto">
        ...
        <p className="text-center capitalize mt-4 text-[#292929]">
          ...
          expect when you hire one for your event.
        </p>
      </div>
      <div className="flex flex-col md:flex-row items-start gap-4 md:gap-10 md:mx-3.5 mt-20">
