...
export default function HowItWorkSection2({ text1, text2, text3, name }) {
  const data = [
    {
      icon1: icon1,
      icon2: icon4,
          ...
          {data.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 justify-between ">
                ...
                <Image
                  alt="Hen party planning with buff butler service"
                  title="Easy Booking Hunky Butler Service"
                  src={item.icon2}
                />
              </div>
