...
<div className='bg-[#ECDFE4] relative'>
      <div className='py-16  max-w-7xl mx-auto container md:px-8 lg:px-0 py-16'>
        ...
        <SecondaryTitle  text1={'Trusted by thousands of'} text2={'party planners'}/>
      <div className='text-center'>
          <SubTitle text={"See why hen parties and birthdays across the UK rate us 5 stars for buff butler hire."}/>
      </div>
...
<div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-[#ECDFE4]"></div>
    ...
    <div className='absolute top-0 left-0'>   <Image alt='img' src={bg1}/> </div>
    <div className='absolute bottom-0 leading-0'>   <Image alt='img' src={bg2}/> </div>
