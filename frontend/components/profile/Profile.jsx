...
export default function Profile() {
  ...
  const [
    changePassword,
    { isLoading: changeLoading, error: changePasswordError },
  ] = useChangePasswordMutation();
      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='flex flex-col lg:flex-row gap-6'>
          ...
          <div className='lg:w-3/4'>
            ...
            {activeTab === "profile" && (
              <div className='bg-white rounded-3xl shadow-sm p-6'>
                <h2 className='text-xl font-bold text-[#424242] mb-6'>
                  Profile Information
                </h2>
              ...
              profile?.data?.isButler !== "active" && (
                <div className='bg-white rounded-3xl shadow-sm p-6'>
                  <div className='flex items-center justify-between mb-6'>
                    <div>
                      ...
                      <p className='text-sm text-[#777] mt-1'>
                        Your Butler profile details and application status.
                      </p>
                    </div>
                  ...
                  <div className='p-4 bg-gray-50 rounded-xl mb-6 flex items-center justify-between'>
                    ...
                    {profile?.data?.isButler === "pending" && (
                      <span className='text-yellow-600 text-lg font-semibold animate-pulse'>
                        ●
                      </span>
                    )}
                  </div>
                  ...
                  {profile?.data?.isButler === "none" && (
                    <div className='p-6 bg-gray-50 rounded-2xl text-center mt-6'>
                      <p className='text-[#555] text-sm mb-2'>
                        You haven't applied as a Butler yet.
                      </p>
                      <button
                        onClick={() => setIsApplicationModalOpen(true)}
            ...
            <form onSubmit={handleApplicationSubmit} className='space-y-6'>
              ...
              <div className='flex items-start gap-3 p-4 bg-gray-50 rounded-xl'>
                ...
                <label
                  ...
                  . I understand that my application will be reviewed and I must
