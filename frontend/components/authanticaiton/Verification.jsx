    ...
    <div className="min-h-screen flex items-start justify-center bg-[#f6f4f5] p-6">
      <div className="w-full max-w-xl mt-12">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold text-gray-900">Two Step Verification</h1>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-[0_25px_40px_rgba(0,0,0,0.04)] border border-white/30">
          <form onSubmit={handleSendOtp} className="space-y-6">
            <label className="block text-sm font-semibold text-gray-800">Enter Your Email</label>
            <input
              type="email"
              required
              value={email}
